 ...
 * Конечно же свои методы класс иметь может.
 */

package LessonsAboutAbstaract;

public class Lama extends Animal implements Moveable{
	public Lama() {
	}
	
	@Override
	public void sleep() {// переопределяем метод абстрактного класса Animal
		System.out.println("Lama is sleeping");
		
	}
	
	@Override
	public void drink() {// переопределяем метод абстрактного класса Animal
		System.out.println("Lama is drinking");
		
	}

	@Override
	public void move() {// переопределяем метод интерфейса Moveable
		System.out.println("Lama is moving");
	}
	
	public void spiting() {
		System.out.println("Lama is spiting");
	}
	
	/////////////////////////////////////////
	
	public Lama(String name, boolean carnivorous) {
		 ...
		 * 
		 */
		System.out.println("И только теперь мы в конструкторе Lama");
	}
